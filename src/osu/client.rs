...
pub struct Client {
    http: Arc<http::Http>,
    updater_state: Arc<RwLock<TaskState>>,
...
impl Default for Client {
    fn default() -> Self {
        ...
        Self {
            ...
            updater_state: Arc::new(RwLock::new(TaskState::default())),
...
impl Client {
    ...
    pub fn start_updating_beatmap(&self, beatmap_id: u32) {
        ...
        self.rt.spawn(async move {
            *updater_state.write().await = TaskState::Running;

            while *updater_state.read().await == TaskState::Running {
    ...
    pub fn stop_updating_beatmap(&self) {
        ...
        self.rt.spawn(async move {
            *updater_state.write().await = TaskState::Stopping;
        });
    }
